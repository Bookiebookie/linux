...
static int __init backport_init(void)
{
	...
	printk(KERN_INFO "Loading modules backported from " CONFIG_KERNEL_NAME
	...
	printk(KERN_INFO "Backport integrated by backports.git " CONFIG_VERSION "\n");
#else
	printk(KERN_INFO "Backport generated by backports.git " CONFIG_VERSION "\n");
